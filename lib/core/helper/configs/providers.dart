...
import 'package:client/views/dashboard/gig/presentation/provider/saved_gig_provider.dart';
...
class Providers {
  static List<SingleChildWidget> getProviders = [
    ...
    ChangeNotifierProvider<SavedGigProvider>(
        create: (_) => SavedGigProvider(inject())),
  ];
}
